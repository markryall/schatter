...
Destroying a message:
  ...
  curl -H 'Content-Type: application/json' -H "Accept: application/json" -X DELETE http://localhost:3000/messages/c2d9a906-25de-4981-afe4-cd3b6c0e099c?auth_token=96b97445-9694-4506-aa14-82ec76c50629
